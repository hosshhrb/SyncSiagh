...
try {
    ...
    Write-Host "   ⚠️  Warning: Prisma generation failed" -ForegroundColor Yellow
...
if (-not (Test-Path ".env")) {
    ...
    if (Test-Path ".env.example") {
        ...
        Write-Host ""
        Write-Host "   ⚠️  IMPORTANT: Edit .env file with your actual credentials!" -ForegroundColor Red
        Write-Host ""
...
Write-Host "      pm2 start dist/main.js --name siaghsync" -ForegroundColor Green
Write-Host ""
...
Write-Host "     node dist/main.js" -ForegroundColor Green
Write-Host ""
...
Write-Host "   3. Start application: node dist/main.js" -ForegroundColor White
